...
export default async function ApiDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <SectionPage title={api.name} intro={api.description}>
      <dl className="details"><div><dt>Endpoint</dt><dd><code>POST {api.path}</code></dd></div><div><dt>Price</dt><dd>{api.price}</dd></div><div><dt>Network</dt><dd>Stellar Testnet</dd></div><div><dt>Mode</dt><dd>Charge per request</dd></div></dl>
